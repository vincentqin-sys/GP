...
import ddlr_detail, kpl, multi_kline, ddlr_struct, zs, tck
...
class FuPanMgrWindow(base_win.BaseWindow):
    ...
    def createWindow(self, parentWnd, rect, style=win32con.WS_VISIBLE | win32con.WS_CHILD, className='STATIC', title=''):
        ...
        gp = base_win.GroupButton([{'name': 'KPL', 'title': '开盘啦'}, {'name': 'DDLR_STRUCT', 'title': '大单流入'}, {'name': 'THS_ZS', 'title': '指数'}, {'name': 'TCK', 'title': '题材库'}])
        gp.setSelGroup(0)
