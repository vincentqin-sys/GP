...
class TableWindow(base_win.BaseWindow):
    ...
    def drawRows(self, hdc):
        ...
        for i in range(*vr):
            if i == self.selIdx:
                self.drawer.fillRect(hdc, (0, y, sz, y + self.ROW_HEIGHT), 0x393533)
...
class FuPanMgrWindow(base_win.BaseWindow):
    ...
    def create(self):
        ...
        self.fsWin.update('601096', 20240119)
        self.fsWin.model.filterDDLR(300)
        self.tableWin.setData(self.fsWin.model.ddlrFilterData)
